...
var productionExists{t in Type, w in 0..Week} binary; # existance of production of certain type
...
OperationsException1 {w in 1..Week}: productionExists['R',w] + productionExists['I',w] <= 1;
OperationsException2 {w in 1..Week}: productionExists['R',w-1] + productionExists['I',w] <= 1;
